...
def parse_arguments_single_run():
    ...
    parser.add_argument("--cache_dtype", type=str, default=None)
...
def load_model(model_name, batch_size, dtype='bfloat16', tp = 1, pp = 1, ep = False, dp = 1):
    ...
    max_model_len = min(supported_max_len, 10000)
...
def save_results(args, aggregated_data, path, batch_size = None):
    ...
    aggregated_data['TP Size'] = args.tensor_parallel
    aggregated_data['PP Size'] = args.pipeline_parallel
    aggregated_data['EP'] = args.expert_parallel
