...
def parse_arguments_single_run():
    ...
    parser.add_argument("--memory_util",             type=float,default=0.9, help="vLLM GPU memory utilization")
    parser.add_argument("--backend",                 type=str,  default=None, help='ray or mp')
